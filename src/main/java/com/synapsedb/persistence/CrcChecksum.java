...
/**
 * CRC32C helper for ring file record integrity (Phase 6 D1).
 *
 * <p>CRC32C is hardware-accelerated on x86/ARM via the JDK's intrinsified implementation
 * ({@link java.util.zip.CRC32C}, available since Java 9). Cost: ~5-20 ns for a 28-byte record.
 *
